...
Employed TensorFlow Lite for on-device AI model execution, enhancing features
such as medical analysis and personalized recommendations.
Used scikit-learn and Keras for developing and training machine learning models.

Optical Character Recognition (OCR):
Integrated Tesseract OCR and Google Cloud Vision to process and digitize medical
